...
public class AddNetscalerLoadBalancerCmd extends BaseAsyncCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException, ConcurrentOperationException,
        ...
        NetworkElementApiExecutor.execute(() -> {
            ExternalLoadBalancerDeviceVO lbDeviceVO = NetworkElementApiExecutor.requireNonNull(_netsclarLbService.addNetscalerLoadBalancer(this),
                    "Failed to add netscaler load balancer due to internal error.");
