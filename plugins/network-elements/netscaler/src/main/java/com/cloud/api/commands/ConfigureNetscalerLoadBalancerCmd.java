...
public class ConfigureNetscalerLoadBalancerCmd extends BaseAsyncCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException, ConcurrentOperationException,
        ...
        NetworkElementApiExecutor.execute(() -> {
            ExternalLoadBalancerDeviceVO lbDeviceVO = NetworkElementApiExecutor.requireNonNull(_netsclarLbService.configureNetscalerLoadBalancer(this),
                    "Failed to configure netscaler load balancer due to internal error.");
