...
public class SecondaryStorageManagerTest {
    ...
    public void validateVerifySshAccessOnManagementNicForSystemVm() {
        ...
        List<Hypervisor.HypervisorType> hypervisorTypesThatMustReturnManagementNic = new ArrayList<>(Arrays.asList(Hypervisor.HypervisorType.Hyperv, Hypervisor.HypervisorType.Proxmox));
