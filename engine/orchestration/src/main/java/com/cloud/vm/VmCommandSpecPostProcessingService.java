...
public interface VmCommandSpecPostProcessingService {
    ...
    void setEnterSetupMode(VirtualMachineTO vmTo, Map<VirtualMachineProfile.Param, Object> params);

    void addExtraConfig(VirtualMachineTO vmTO);

    void prepareManagedDiskPaths(DiskTO[] disks, HypervisorType hypervisorType);

    void applyStartAnswerDiskMetadata(DiskTO[] disks, Map<String, Map<String, String>> iqnToData);
