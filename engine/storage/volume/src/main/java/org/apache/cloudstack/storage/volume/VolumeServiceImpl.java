...
public class VolumeServiceImpl implements VolumeService {
    ...
    @Inject
    protected SecondaryStorageVolumeService secondaryStorageVolumeService;
    ...
    public void handleVolumeSync(DataStore store) {
        secondaryStorageVolumeService.handleVolumeSync(store, this::createVolumeAsync);
    }
    ...
    public void moveVolumeOnSecondaryStorageToAnotherAccount(Volume volume, Account sourceAccount, Account destAccount) {
        secondaryStorageVolumeService.moveVolumeOnSecondaryStorageToAnotherAccount(volume, sourceAccount, destAccount);
    }

    protected String buildVolumePath(long accountId, long volumeId) {
        return secondaryStorageVolumeService.buildVolumePath(accountId, volumeId);
    }
}
