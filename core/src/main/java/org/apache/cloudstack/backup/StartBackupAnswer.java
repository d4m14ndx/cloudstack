...
public class StartBackupAnswer extends Answer {
    ...
    public StartBackupAnswer(StartBackupCommand command, boolean success, String details) {
        super(command, success, details);
    }

    public StartBackupAnswer(StartBackupCommand command, boolean success, String details, Long checkpointCreateTime) {
        super(command, success, details);
