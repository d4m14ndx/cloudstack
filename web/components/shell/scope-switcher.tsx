    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <ul className="absolute left-0 right-0 top-[calc(100%+4px)] z-20 overflow-hidden rounded-lg border border-[color:var(--border)] bg-[color:var(--bg-elevated)] shadow-[var(--shadow-md)]">
            {SCOPES.map((s) => (
              <li key={s.id}>
                <button
                  type="button"
