        ...
        <a-col :md="24" :lg="17">
          <a-card :bordered="true">
            <a-form
              ...
              <a-form-item name="templateid" ref="templateid" v-if="cluster.hypervisortype === 'VMware' || (['KVM', 'Proxmox'].includes(cluster.hypervisortype) && !selectedVmwareVcenter && !isDiskImport && !isExternalImport)">
                <template #label>
