...
public interface ApiDirectDownloadCertificateResponseService {

    void handleCertificateResponse(String certStr, DirectDownloadCertificateResponse response);
    ...
    DirectDownloadCertificateHostStatusResponse createDirectDownloadCertificateHostStatusResponse(DirectDownloadManager.HostCertificateStatus hostStatus);
