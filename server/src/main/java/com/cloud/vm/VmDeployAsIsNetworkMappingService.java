...
public interface VmDeployAsIsNetworkMappingService {

    LinkedHashMap<Integer, Long> getDeployAsIsVmNetworkMapping(DataCenter zone, Account owner,
    ...
    interface DefaultNetworkProvider {
